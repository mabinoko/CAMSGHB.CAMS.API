...
{
    public partial class DBCams2context : DbContext
    {
        public DBCams2context()
        {
        }

        public DBCams2context(DbContextOptions<DBCams2context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=207.148.69.13;Database=dbCams2;User ID=dbcams;Password=123456Ws");
            }
        }
